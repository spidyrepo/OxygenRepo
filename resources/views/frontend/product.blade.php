                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="<?= asset('assets') ?>/images/products/variable/1-800x900.jpg"
                                                            data-zoom-image="<?= asset('assets') ?>/images/products/variable/1-800x900.jpg"
                                                            alt="Electronics Black Wrist Watch" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="<?= asset('assets') ?>/images/products/variable/2-800x900.jpg"
                                                            data-zoom-image="<?= asset('assets') ?>/images/products/variable/2-800x900.jpg"
                                                            alt="Electronics Black Wrist Watch" width="488" height="549">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="<?= asset('assets') ?>/images/products/variable/3-800x900.jpg"
                                                            data-zoom-image="<?= asset('assets') ?>/images/products/variable/3-800x900.jpg"
                                                            alt="Electronics Black Wrist Watch" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="<?= asset('assets') ?>/images/products/variable/4-800x900.jpg"
                                                            data-zoom-image="<?= asset('assets') ?>/images/products/variable/4-800x900.jpg"
                                                            alt="Electronics Black Wrist Watch" width="800" height="900">
                                                    </figure>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 mb-6 mb-md-8">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        ...
                                        <div class="product-bm-wrapper">
                                            <figure class="brand">
                                                <img src="<?= asset('assets') ?>/images/products/brand/brand-2.jpg" alt="Brand"
                                                    width="105" height="48" />
                                            </figure>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6 mb-4">
                                                <figure class="vendor-banner br-sm">
                                                    <img src="<?= asset('assets') ?>/images/products/vendor-banner.jpg"
                                            ...
                                            <div class="col-md-6 pl-2 pl-md-6 mb-4">
                                                <div class="vendor-user">
                                                    <figure class="vendor-logo mr-4">
                                                        <a href="#">
                                                            <img src="<?= asset('assets') ?>/images/products/vendor-logo.jpg"
