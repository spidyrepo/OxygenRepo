                ...
                <!-- <div class="sidebar-popup"><a class="popup-btn">filterrrrrrrrr
                            ...
                            <form  method="POST" action ="{{ route('subfilterproducts') }}">
                                                        ...
                                                        <div class="open-popup">
                                                            <div class="collection-filter" style="padding:30px;">
                                                                        ...
                                                                        <div class="collection-collapse-block-content">
                                                                            <div class="collection-brand-filter">
                                                                                <div class="row" style="width:300px;">
                                                                                    <div class="col-6">
                                                                                      <h6>Min
                                                                                     <input type="number" name="pricemin"  value ="0" class="form-control" width: 200px;></h6>
                                                                                    </div>
                                                                                     <div class="col-6">
                                                                                      <h6>Max
                                                                                     <input type="number" name="pricemax"  value ="" class="form-control"width: 200px;> </h6>
                                                                                    </div>
                                                                                  </div>
                                                                            </div>
                                                                        </div>
