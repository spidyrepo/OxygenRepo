   ...
   @include('paritials.website.header')
	 ...
	 @if(count($categorys) > 0)
	   <div class="title1 section-t-space pt-5">
        ...
        <h4 class="title-inner1 text-left">{{strtoupper($category->category_main_name)}} / {{strtoupper($category->category_name)}} </h4>
        <p style="font-size: 15px; position: absolute; top: 420px; left:540px"><b>{{count($product)}} Products Per Page</b></p>
    </div>
