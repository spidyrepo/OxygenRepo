            ...
            <div class="page-content">
                <div class="container">
                    ...
                    <div class="shop-default-banner banner d-flex align-items-center mb-5 br-xs"
                        style="background-image: url(/website_assets/images/shop/banner1.jpg); background-color: #FFC74E;">
                            ...
                            <div class="swiper-wrapper row gutter-lg cols-xl-8 cols-lg-7 cols-md-6 cols-sm-4 cols-xs-3 cols-2">
                                    ...
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="/website_assets/images/categories/category-4.jpg" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="/website_assets/images/categories/category-5.jpg" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="/website_assets/images/categories/category-6.jpg" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="/website_assets/images/categories/category-7.jpg" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="/website_assets/images/categories/category-8.jpg" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="/website_assets/images/categories/category-9.jpg" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="/website_assets/images/categories/category-20.jpg" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="/website_assets/images/categories/category-21.jpg" alt="Categroy"
                                        ...
                                        <div class="product text-center">
                                            ...
                                            <div class="product-details">
                                                <div class="product-cat">
                                                    <a href="shop-banner-sidebar.html">{{ $product->CategoryMain->category_main_name }}</a>
                                                </div>
                                                ...
                                                <div class="product-pa-wrapper">
                                                    <div class="product-price">
                                                        ₹{{ $product->productdetails->selling_price }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
