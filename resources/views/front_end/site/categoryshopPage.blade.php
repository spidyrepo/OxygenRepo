                ...
                <div class="container">
                    ...
                    <div class="shop-default-banner banner d-flex align-items-center mb-5 br-xs" style="background-image: url( {{ asset('/website_assets/images/banner1.jpg ') }} );background-color: #FFC74E;">
                        <div class="banner-content row">
                            ...
                            <div class="col-9">
                            <h4 class="banner-subtitle font-weight-bold">{{$maincategory->category_main_name}} Collection</h4>
                            <h3 class="banner-title text-white text-uppercase font-weight-bolder ls-normal">  {{$category->category_name}} </h3>
                    ...
                    <h4>  {{$category->category_name}} Categories </h4>
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="{{ url( 'Subcategoryproductshow/'.$category->id ) }}">
                                            @if($category->category_sub_image!='' && file_exists(public_path('assets/images/categorySub/' . $category->category_sub_image)))
                                                    <img src="{{ asset('/assets/images/categorySub/'.$category->category_sub_image) }}" alt="{{ $category->category_name }}"
                                        ...
                                        <div class="category-content">
                                            <h4 class="category-name">
                                                <a href="{{ url( 'Subcategoryproductshow/'.$category->id ) }}">{{ $category->category_sub_name }}</a>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <aside class="sidebar shop-sidebar sticky-sidebar-wrapper sidebar-fixed">
                            ...
                            <div class="sidebar-content scrollable">
                                ...
                                <div class="sticky-sidebar">
                                    ...
                                    <!-- Start of Collapsible widget -->
                                    <div class="widget widget-collapsible">
                                        <h3 class="widget-title"><label> {{$category->category_name}} Categories</label></h3>
                                        <ul class="widget-body filter-items search-ul">
                                        @foreach($categories as $category)
                                            <li><a href="{{ url( 'Subcategoryproductshow/'.$category->id ) }}">
                                            @if($category->category_sub_image!='' && file_exists(public_path('assets/images/categorySub/' . $category->category_sub_image)))
...
function getproducts()
{
    ...
    $.ajax({
            ...
            data:{minprice:min_price,maxprice:max_price,orderby:orderby,id:cateid},
            method: 'GET',
