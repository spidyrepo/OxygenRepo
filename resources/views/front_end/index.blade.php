...
<html lang="en">
	...
	<head>
		...
		<script>
			...
			var links={{ asset('website_assets/js/webfont.js')}};
			(function (d) {
			...
			<main class="main">
				<div class="container pb-2">
					<div class="intro-wrapper mt-4">
						...
						'disableOnInteraction': false
							...
							<div class="swiper-wrapper">
                                ...
                                style="background-image: url({{ asset('website_assets/images/demos/demo8/slides/slide-1.jpg')}}"); background-color: #E8EAEF;">
							...
							style="background-image: url({{ asset('website_assets/images/demos/demo8/slides/slide-2.jpg')}}"); background-color: #2e3233;">
					...
					<div class="swiper-slide banner banner-fixed intro-slide intro-slide3 br-sm"
						style="background-image: url({{ asset('website_assets/images/demos/demo8/slides/slide-3.jpg')}}"); background-color:#363332;">
						<div class="banner-content y-50">
							<div class="slide-animate" data-animation-options="{
		...
		'slidesPerView': 3
			...
			<div class="swiper-wrapper row cols-lg-3 cols-sm-2 cols-1">
				<div class="swiper-slide banner banner-fixed category-banner br-sm">
					<figure>
						<img src="{{ asset('website_assets/images/demos/demo8/category/1-1.jpg')}}" alt="Category Banner" width="447"
				...
				<div class="swiper-slide banner banner-fixed category-banner br-sm">
					<figure>
						<img src="{{ asset('website_assets/images/demos/demo8/category/1-2.jpg')}}" alt="Category Banner" width="447"
				...
				<div class="swiper-slide banner banner-fixed category-banner br-sm">
					<figure>
						<img src="{{ asset('website_assets/images/demos/demo8/category/1-3.jpg')}}" alt="Category Banner" width="447"
			...
			<div class="swiper-wrapper row cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
					...
					<div class="category category-classic category-absolute overlay-zoom br-sm">
						<a href="demo8-shop.html">
							<figure class="category-media">
								<img src="{{ asset('website_assets/images/demos/demo8/product/1-1.jpg')}}" alt="Category" width="213"
								height="213" />
							</figure>
						</a>
				...
				<div class="swiper-slide category-wrap">
					<div class="category category-classic category-absolute overlay-zoom br-sm">
						<a href="demo8-shop.html">
							<figure class="category-media">
								<img src="{{ asset('website_assets/images/demos/demo8/product/1-2.jpg')}}" alt="Category" width="213"
								height="213" />
							</figure>
						</a>
						<div class="category-content">
				...
				<div class="swiper-slide category-wrap">
					<div class="category category-classic category-absolute overlay-zoom br-sm">
						<a href="demo8-shop.html">
							<figure class="category-media">
								<img src="{{ asset('website_assets/images/demos/demo8/product/1-3.jpg')}}" alt="Category" width="213"
								height="213" />
							</figure>
						</a>
						<div class="category-content">
				...
				<div class="swiper-slide category-wrap">
					<div class="category category-classic category-absolute overlay-zoom br-sm">
						<a href="demo8-shop.html">
							<figure class="category-media">
								<img src="{{ asset('website_assets/images/demos/demo8/product/1-4.jpg')}}" alt="Category" width="213"
								height="213" />
							</figure>
						</a>
						<div class="category-content">
				...
				<div class="swiper-slide category-wrap">
					<div class="category category-classic category-absolute overlay-zoom br-sm">
						<a href="demo8-shop.html">
							<figure class="category-media">
								<img src="{{ asset('website_assets/images/demos/demo8/product/1-5.jpg')}}" alt="Category" width="213"
								height="213" />
							</figure>
						</a>
						<div class="category-content">
				...
				<div class="swiper-slide category-wrap">
					<div class="category category-classic category-absolute overlay-zoom br-sm">
						<a href="demo8-shop.html">
							<figure class="category-media">
								<img src="{{ asset('website_assets/images/demos/demo8/product/1-6.jpg')}}" alt="Category" width="213"
								height="213" />
							</figure>
						</a>
						<div class="category-content">
	...
	<section class="grey-section appear-animate">
					...
					<div class="row cols-xl-5 cols-md-4 cols-sm-3 cols-2">
							...
							<div class="product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-1-1.jpg')}}" alt="Product"
										width="300" height="338" />
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-1-2.jpg')}}" alt="Product"
										width="300" height="338" />
									</a>
						...
						<div class="product-wrap">
							<div class="product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-2.jpg')}}" alt="Product"
										width="300" height="338" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
						...
						<div class="product-wrap">
							<div class="product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-3.jpg')}}" alt="Product"
										width="300" height="338" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
						...
						<div class="product-wrap">
							<div class="product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-4-1.jpg')}}" alt="Product"
										width="300" height="338" />
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-4-2.jpg')}}" alt="Product"
										width="300" height="338" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
						...
						<div class="product-wrap">
							<div class="product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-5.jpg')}}" alt="Product"
										width="300" height="338" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
						...
						<div class="product-wrap">
							<div class="product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-6-1.jpg')}}" alt="Product"
										width="300" height="338" />
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-6-2.jpg')}}" alt="Product"
										width="300" height="338" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
						...
						<div class="product-wrap">
							<div class="product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-7.jpg')}}" alt="Product"
										width="300" height="338" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
						...
						<div class="product-wrap">
							<div class="product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-8-1.jpg')}}" alt="Product"
										width="300" height="338" />
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-8-2.jpg')}}" alt="Product"
										width="300" height="338" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
						...
						<div class="product-wrap">
							<div class="product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-9.jpg')}}" alt="Product"
										width="300" height="338" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
						...
						<div class="product-wrap">
							<div class="product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/3-10.jpg')}}" alt="Product"
										width="300" height="338" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
			...
			<div class="row category-cosmetic-lifestyle appear-animate mb-5">
				<div class="col-md-6 mb-4">
					<div class="banner banner-fixed category-banner-1 br-xs">
						<figure>
							<img src="{{ asset('website_assets/images/demos/demo1/categories/3-1.jpg')}}" alt="Category Banner"
				...
				<div class="col-md-6 mb-4">
					<div class="banner banner-fixed category-banner-2 br-xs">
						<figure>
							<img src="{{ asset('website_assets/images/demos/demo1/categories/3-2.jpg')}}" alt="Category Banner"
			...
			<div class="product-wrapper-1 appear-animate mb-5">
				...
				<div class="row">
					<div class="col-lg-3 col-sm-4 mb-4">
						<div class="banner h-100 br-sm" style="background-image: url({{ asset('website_assets/images/demos/demo1/banners/2.jpg')}}"); 
						...
						<div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
							<div class="swiper-slide product-col">
								<div class="product-wrap product text-center">
									<figure class="product-media">
										<a href="#">
											<img src="{{ asset('website_assets/images/demos/demo1/products/4-1.jpg')}}" alt="Product"
								...
								<div class="product-wrap product text-center">
									<figure class="product-media">
										<a href="#">
											<img src="{{ asset('website_assets/images/demos/demo1/products/4-5-1.jpg')}}"
											alt="Product" width="216" height="243" />
											<img src="{{ asset('website_assets/images/demos/demo1/products/4-5-2.jpg')}}"
											alt="Product" width="216" height="243" />
										</a>
										<div class="product-action-vertical">
											<a href="#" class="btn-product-icon btn-cart w-icon-cart"
							...
							<div class="swiper-slide product-col">
								<div class="product-wrap product text-center">
									<figure class="product-media">
										<a href="#">
											<img src="{{ asset('website_assets/images/demos/demo1/products/4-2-1.jpg')}}"
											alt="Product" width="216" height="243" />
											<img src="{{ asset('website_assets/images/demos/demo1/products/4-2-2.jpg')}}"
											alt="Product" width="216" height="243" />
										</a>
										<div class="product-action-vertical">
											<a href="#" class="btn-product-icon btn-cart w-icon-cart"
								...
								<div class="product-wrap product text-center">
									<figure class="product-media">
										<a href="#">
											<img src="{{ asset('website_assets/images/demos/demo1/products/4-6.jpg')}}" alt="Product"
											width="216" height="243" />
										</a>
										<div class="product-action-vertical">
											<a href="#" class="btn-product-icon btn-cart w-icon-cart"
							...
							<div class="swiper-slide product-col">
								<div class="product-wrap product text-center">
									<figure class="product-media">
										<a href="#">
											<img src="{{ asset('website_assets/images/demos/demo1/products/4-3.jpg')}}" alt="Product"
											width="216" height="243" />
										</a>
										<div class="product-action-vertical">
											<a href="#" class="btn-product-icon btn-cart w-icon-cart"
								...
								<div class="product-wrap product text-center">
									<figure class="product-media">
										<a href="#">
											<img src="{{ asset('website_assets/images/demos/demo1/products/4-7.jpg')}}" alt="Product"
											width="216" height="243" />
										</a>
										<div class="product-action-vertical">
											<a href="#" class="btn-product-icon btn-cart w-icon-cart"
							...
							<div class="swiper-slide product-col">
								<div class="product-wrap product text-center">
									<figure class="product-media">
										<a href="#">
											<img src="{{ asset('website_assets/images/demos/demo1/products/4-4-1.jpg')}}"
											alt="Product" width="216" height="243" />
											<img src="{{ asset('website_assets/images/demos/demo1/products/4-4-2.jpg')}}"
											alt="Product" width="216" height="243" />
										</a>
										<div class="product-action-vertical">
											<a href="#" class="btn-product-icon btn-cart w-icon-cart"
								...
								<div class="product-wrap product text-center">
									<figure class="product-media">
										<a href="#">
											<img src="{{ asset('website_assets/images/demos/demo1/products/4-8.jpg')}}" alt="Product"
											width="216" height="243" />
										</a>
										<div class="product-action-vertical">
											<a href="#" class="btn-product-icon btn-cart w-icon-cart"
		...
		<div class="product-wrapper-1 appear-animate mb-8">
			...
			<div class="row">
				<div class="col-lg-3 col-sm-4 mb-4">
					<div class="banner h-100 br-sm" style="background-image: url({{ asset('website_assets/images/demos/demo1/banners/3.jpg')}}"); 
					...
					<div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
						<div class="swiper-slide product-col">
							<div class="product-wrap product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/5-1-1.jpg')}}"
										alt="Product" width="216" height="243" />
										<img src="{{ asset('website_assets/images/demos/demo1/products/5-1-2.jpg')}}"
										alt="Product" width="216" height="243" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
							...
							<div class="product-wrap product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/5-5.jpg')}}" alt="Product"
										width="216" height="243" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
						...
						<div class="swiper-slide product-col">
							<div class="product-wrap product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/5-2-1.jpg')}}"
										alt="Product" width="216" height="243" />
										<img src="{{ asset('website_assets/images/demos/demo1/products/5-2-2.jpg')}}"
										alt="Product" width="216" height="243" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
							...
							<div class="product-wrap product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/5-6.jpg')}}" alt="Product"
										width="216" height="243" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
						...
						<div class="swiper-slide product-col">
							<div class="product-wrap product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/5-3.jpg')}}" alt="Product"
										width="216" height="243" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
							...
							<div class="product-wrap product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/5-7.jpg')}}" alt="Product"
										width="216" height="243" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
						...
						<div class="swiper-slide product-col">
							<div class="product-wrap product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/5-4.jpg')}}" alt="Product"
										width="216" height="243" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
							...
							<div class="product-wrap product text-center">
								<figure class="product-media">
									<a href="product-default.html">
										<img src="{{ asset('website_assets/images/demos/demo1/products/5-8.jpg')}}" alt="Product"
										width="216" height="243" />
									</a>
									<div class="product-action-vertical">
										<a href="#" class="btn-product-icon btn-cart w-icon-cart"
	...
	<div class="banner banner-fashion appear-animate br-sm mb-9" style="background-image: url({{ asset('website_assets/images/demos/demo1/banners/4.jpg')}}");
	...
	<div class="swiper-wrapper row gutter-no cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
		<div class="swiper-slide brand-col">
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/1.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/2.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
		</div>
		<div class="swiper-slide brand-col">
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/3.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/4.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
		</div>
		<div class="swiper-slide brand-col">
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/5.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/6.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
		</div>
		<div class="swiper-slide brand-col">
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/7.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/8.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
		</div>
		<div class="swiper-slide brand-col">
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/9.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/10.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
		</div>
		<div class="swiper-slide brand-col">
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/11.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
			<figure class="brand-wrapper">
				<img src="{{ asset('website_assets/images/demos/demo1/brands/12.png')}}" alt="Brand" width="410"
				height="186" />
			</figure>
		</div>
	</div>
	...
	<div class="swiper-wrapper row cols-xl-8 cols-lg-6 cols-md-4 cols-2">
			...
			<div class="product text-center product-absolute">
				<figure class="product-media">
					<a href="product-defaproduct-default.html">
						<img src="{{ asset('website_assets/images/demos/demo1/products/7-1.jpg')}}" alt="Category image"
		...
		<div class="swiper-slide product-wrap mb-0">
			<div class="product text-center product-absolute">
				<figure class="product-media">
					<a href="product-defaproduct-default.html">
						<img src="{{ asset('website_assets/images/demos/demo1/products/7-2.jpg')}}" alt="Category image"
						width="130" height="146" style="background-color: #fff" />
					</a>
				</figure>
				<h4 class="product-name">
		...
		<div class="swiper-slide product-wrap mb-0">
			<div class="product text-center product-absolute">
				<figure class="product-media">
					<a href="product-defaproduct-default.html">
						<img src="{{ asset('website_assets/images/demos/demo1/products/7-3.jpg')}}" alt="Category image"
						width="130" height="146" style="background-color: #fff" />
					</a>
				</figure>
				<h4 class="product-name">
		...
		<div class="swiper-slide product-wrap mb-0">
			<div class="product text-center product-absolute">
				<figure class="product-media">
					<a href="product-defaproduct-default.html">
						<img src="{{ asset('website_assets/images/demos/demo1/products/7-4.jpg')}}" alt="Category image"
						width="130" height="146" style="background-color: #fff" />
					</a>
				</figure>
				<h4 class="product-name">
		...
		<div class="swiper-slide product-wrap mb-0">
			<div class="product text-center product-absolute">
				<figure class="product-media">
					<a href="product-defaproduct-default.html">
						<img src="{{ asset('website_assets/images/demos/demo1/products/7-5.jpg')}}" alt="Category image"
						width="130" height="146" style="background-color: #fff" />
					</a>
				</figure>
				<h4 class="product-name">
		...
		<div class="swiper-slide product-wrap mb-0">
			<div class="product text-center product-absolute">
				<figure class="product-media">
					<a href="product-defaproduct-default.html">
						<img src="{{ asset('website_assets/images/demos/demo1/products/7-6.jpg')}}" alt="Category image"
						width="130" height="146" style="background-color: #fff" />
					</a>
				</figure>
				<h4 class="product-name">
		...
		<div class="swiper-slide product-wrap mb-0">
			<div class="product text-center product-absolute">
				<figure class="product-media">
					<a href="product-defaproduct-default.html">
						<img src="{{ asset('website_assets/images/demos/demo1/products/7-7.jpg')}}" alt="Category image"
						width="130" height="146" style="background-color: #fff" />
					</a>
				</figure>
				<h4 class="product-name">
		...
		<div class="swiper-slide product-wrap mb-0">
			<div class="product text-center product-absolute">
				<figure class="product-media">
					<a href="product-defaproduct-default.html">
						<img src="{{ asset('website_assets/images/demos/demo1/products/7-8.jpg')}}" alt="Category image"
						width="130" height="146" style="background-color: #fff" />
					</a>
				</figure>
				<h4 class="product-name">
		...
		<div class="dropdown-box">
			<div class="products">
				<div class="product product-cart">
					...
					<figure class="product-media">
						<a href="product-default.html">
							<img src="{{ asset('website_assets/images/cart/product-1.jpg')}}" alt="product" height="84" width="94" />
						</a>
					</figure>
				...
				<div class="product product-cart">
					...
					<figure class="product-media">
						<a href="product-default.html">
							<img src="{{ asset('website_assets/images/cart/product-2.jpg')}}" alt="product" width="84" height="94" />
						</a>
					</figure>
					<button class="btn btn-link btn-close" aria-label="button">
						<i class="fas fa-times"></i>
					...
					<div class="swiper-wrapper row cols-1 gutter-no">
						<div class="swiper-slide">
							<figure class="product-image">
								<img src="{{ asset('website_assets/images/products/popup/1-440x494.jpg')}}"
								data-zoom-image="{{ asset('website_assets/images/products/popup/1-800x900.jpg')}}"
								alt="Water Boil Black Utensil" width="800" height="900">
							</figure>
						</div>
						<div class="swiper-slide">
							<figure class="product-image">
								<img src="{{ asset('website_assets/images/products/popup/2-440x494.jpg')}}"
								data-zoom-image="{{ asset('website_assets/images/products/popup/2-800x900.jpg')}}"
								alt="Water Boil Black Utensil" width="800" height="900">
							</figure>
						</div>
						<div class="swiper-slide">
							<figure class="product-image">
								<img src="{{ asset('website_assets/images/products/popup/3-440x494.jpg')}}"
								data-zoom-image="{{ asset('website_assets/images/products/popup/3-800x900.jpg')}}"
								alt="Water Boil Black Utensil" width="800" height="900">
							</figure>
						</div>
						<div class="swiper-slide">
							<figure class="product-image">
								<img src="{{ asset('website_assets/images/products/popup/4-440x494.jpg')}}"
								data-zoom-image="{{ asset('website_assets/images/products/popup/4-800x900.jpg')}}"
								alt="Water Boil Black Utensil" width="800" height="900">
							</figure>
						</div>
					</div>
				...
				'prevEl': '.swiper-button-prev'
					...
					<div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
						<div class="product-thumb swiper-slide">
							<img src="{{ asset('website_assets/images/products/popup/1-103x116.jpg')}}" alt="Product Thumb" width="103"
							height="116">
						</div>
						<div class="product-thumb swiper-slide">
							<img src="{{ asset('website_assets/images/products/popup/2-103x116.jpg')}}" alt="Product Thumb" width="103"
							height="116">
						</div>
						<div class="product-thumb swiper-slide">
							<img src="{{ asset('website_assets/images/products/popup/3-103x116.jpg')}}" alt="Product Thumb" width="103"
							height="116">
						</div>
						<div class="product-thumb swiper-slide">
							<img src="{{ asset('website_assets/images/products/popup/4-103x116.jpg')}}" alt="Product Thumb" width="103"
							height="116">
						</div>
					</div>
					<button class="swiper-button-next"></button>
		...
		<div class="col-md-6 overflow-hidden p-relative">
			<div class="product-details scrollable pl-0">
				...
				<div class="product-bm-wrapper">
					<figure class="brand">
						<img src="{{ asset('website_assets/images/products/brand/brand-1.jpg')}}" alt="Brand" width="102" height="48" />
					</figure>
