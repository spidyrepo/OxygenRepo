...
<div class="header-middle">
    <div class="container">
        ...
        <div class="header-right ml-4">
            ...
            <a class="wishlist label-down link d-xs-show" href="my-account.html">
                <i class="w-icon-account"></i>
                <span class="wishlist-label d-lg-show">Account</span>
            </a>
            <a class="compare label-down link d-xs-show" href="wishlist.html">
                <i class="w-icon-heart"></i>
                <span class="compare-label d-lg-show">Wishlist</span>
            </a>
