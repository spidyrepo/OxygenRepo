       ...
       <div class="modal-dialog modal-md modal-dialog-centered" role="document">
           <div class="modal-content">
               <div class="modal-header">
                   ...
                   <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="closeQuickView()">
                   ...
                   <div class="row gutter-lg">
                       ...
                       <div class="col-md-6 overflow-hidden p-relative">
                           <div class="product-details scrollable pl-0">
                               <h2 class="product-title">Electronics Black Wrist Watch0000</h2>
   ...
   <script>
    function showQuickView(id)
    {
        ...
        $.magnificPopup.open({
        items: {
            src: '#quickViewModal' // ID of your popup content
        },
        type: 'inline',
        closeBtnInside: true,
        mainClass: 'mfp-fade'
