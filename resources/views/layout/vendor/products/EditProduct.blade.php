                                                                    ...
                                                                    <table class="table table-bordered ">
                                                                        ...
                                                                        <tbody class="spectable">    
                                                                            ...
                                                                            @foreach ($productspecs as $prspec)
                                                                                {{-- @dd($prspec->specify_value) specification   productspecs--}}
                                                                            <tr>
                                                                                <!--<td>-->
                                                                                <!--     <select type="readonly"  class="js-select2 form-control" name="speci_value[]" value="{{$prspec->specify_attribute}}"-->
                                                                                <!--    id="speci_value">-->
                                                                                <!-- <option value="{{ $prspec->id }}">{{ $prspec->name }}</option>-->
                                                                                <!--</select>                                                                               -->
                                                                                <!--</td>-->
                                                                                <td>
                                                                                ...
                                                                                <select class="js-select2 form-control"  name="speci_value[]" id="speci_value[]">
                                                                                    ...
                                                                                    @foreach ($spec as $specify_value)
                                                                                        ...
                                                                                        ?>
                                                                                            <option value="{{ $specify_value }}" {{ ($specify_value == $prspec->specify_value)?'selected':'';}}>
                                                                                            {{ $specify_value }} </option >
