...
class ProductCollectionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('layout.staff.products.product-collection')->with("productcollection", $productcollection);
    ...
    */ 
    ...
    public function listing()
    {
        ...
        return view("layout.staff.products.product-listing")->with("products_list", $products_list_arr);
    }
